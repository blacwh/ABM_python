...
class Simulation:
    ...
    def __init__(self, n, infectn, radius, iterations, inside_division):
...
if __name__ == '__main__':
    ...
    iterations = 100
    inside_division = 1
    sim = Simulation(nparticles, infectn, radius, iterations, inside_division)
